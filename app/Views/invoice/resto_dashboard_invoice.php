...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            <h4 class="text-center">DATA PENAGIHAN (INVOICE) - {NAMA RESTO}</h4>
        </div>
        ...
        <div class="col-lg-12">
            ...
            <h6>ini nanti di sini rencananya kalender per resto, jadi per resto udah tau tgl berapa aja invoice nya dan status outstanding atau completednya</h6>
